...
bookStage.addEventListener('mousemove', (e) => {
    ...
    if (selection && selection.toString().length > 0) { 
        isDragging = false;
        bookStage.classList.remove('fbpH-grabbing-mode'); // ক্লাস সরিয়ে দিন
        return; 
    }
...
function handleBookClick(e) {
    ...
    if (e.target.closest('.fbpH-controls') || e.target.closest('.fbpH-sidebar') || e.target.closest('.fbpH-arrow')) return;
    ...
    // ক্লিকটি যদি বইয়ের (#fbpH-book) ভেতরে না হয়, তাহলে ফাংশন থামিয়ে দিন
